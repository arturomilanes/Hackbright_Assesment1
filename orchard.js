...
console.log("total number of acres is: " + totalAcres);
...
let averageDailyAcres = totalAcres/numOfDays;

console.log("The average number of acres picked per day is: " + averageDailyAcres);
...
console.log(days + " days left of work")
...
for(let i = 0; i < fujiAcres.length; i++)
{
    fujiTons[i] = fujiAcres[i] * tonsPerAcre;
    galaTons[i] = galaAcres[i] * tonsPerAcre;
    pinkTons[i] = pinkAcres[i] * tonsPerAcre;
}
...
fujiPounds = fujiTotalTons * poundsPerTon;
galaPounds = galaTotalTons * poundsPerTon;
pinkPounds = pinkTotalTons * poundsPerTon;

console.log("pounds picked in fuji: " + fujiPounds + " lbs");
console.log("pounds picked in gala: " + galaPounds + " lbs");
console.log("pounds picked in pink: " + pinkPounds + " lbs");
...
console.log("profit in fuji: $" + fujiProfit);
console.log("profit in gala: $" + galaProfit);
console.log("profit in pink: $" + pinkProfit);
...
console.log("Total profit this week: $" + totalProfit);